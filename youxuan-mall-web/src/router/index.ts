  ...
  routes: [
    ...
    { path: '/register', name: 'register', component: () => import('@/views/auth/RegisterView.vue') },
    {
      ...
      children: [
        ...
        { path: 'coupons', name: 'coupons', component: () => import('@/views/shop/CouponCenterView.vue') },
        { path: 'my-coupons', name: 'my-coupons', component: () => import('@/views/shop/MyCouponsView.vue'), meta: { auth: true } },
